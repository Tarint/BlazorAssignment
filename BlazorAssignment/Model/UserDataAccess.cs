    ...
    public class UserDataAccess : IUserDataAccsess
    {
        ...
        private List<UserData> GetUserDatas()
        {
            List<UserData> listOfUsers = new List<UserData>
            {
                ...
                new UserData(8, "Markus Pärson", "BlockMan", "markus.person@gmail.com", "7636758362", new Address("Stationsgatan", "Malmö", "21143"), new Company("Mojang", "Endless possibilities")),
